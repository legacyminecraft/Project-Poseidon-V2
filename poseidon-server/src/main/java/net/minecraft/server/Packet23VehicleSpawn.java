...
public class Packet23VehicleSpawn extends Packet implements OutboundPacket { // Poseidon - implements OutboundPacket

    public static final PacketEncoder<Packet23VehicleSpawn> ENCODER = Packet23VehicleSpawn::a; // Poseidon
