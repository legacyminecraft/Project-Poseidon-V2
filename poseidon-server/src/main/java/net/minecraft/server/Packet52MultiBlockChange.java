...
public class Packet52MultiBlockChange extends Packet implements OutboundPacket { // Poseidon - implements OutboundPacket

    public static final PacketEncoder<Packet52MultiBlockChange> ENCODER = Packet52MultiBlockChange::a; // Poseidon
