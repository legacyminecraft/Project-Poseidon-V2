    ...
    protected void a(Entity entity, float f) {
        if (f < 10.0F) {
            ...
            if (this.attackTicks == 0) {
                ...
                // Poseidon - fix skeleton bow sounds
                this.world.e(1002, MathHelper.floor(this.locX), MathHelper.floor(this.locY - (double) this.height), MathHelper.floor(this.locZ), 0);
                entityarrow.a(d0, d2 + (double) f1, d1, 0.6F, 12.0F);
                this.world.addEntity(entityarrow); // Poseidon - move down
                this.attackTicks = 30;
            }
