...
public interface IWorldAccess {
    ...
    void a(@Nullable String s, double d0, double d1, double d2, float f, float f1);
    ...
    void a(@Nullable String s, int i, int j, int k);

    void a(int i, int j, int k, TileEntity tileentity);

    void a(@Nullable EntityHuman entityhuman, int i, int j, int k, int l, int i1);
}
