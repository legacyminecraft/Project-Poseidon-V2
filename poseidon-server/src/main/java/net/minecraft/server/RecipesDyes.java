...
public class RecipesDyes {
    ...
    public void a(CraftingManager craftingmanager) {
        for (int i = 0; i < 16; ++i) {
            craftingmanager.registerShapelessRecipe(new ItemStack(Block.WOOL, 1, BlockCloth.d(i)), new ItemStack(Item.INK_SACK, 1, i), new ItemStack(Item.byId[Block.WOOL.id], 1, 0));
        }
