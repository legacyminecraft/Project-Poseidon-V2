...
public class BlockPistonExtension extends Block {
    ...
    public void remove(World world, int i, int j, int k) {
        ...
        if ((l & 7) >= PistonBlockTextures.a.length) return; // CraftBukkit - fixed a piston AIOOBE issue.
    ...
    public void doPhysics(World world, int i, int j, int k, int l) {
        ...
        if ((i1 & 7) >= PistonBlockTextures.a.length) return; // CraftBukkit - fixed a piston AIOOBE issue.
