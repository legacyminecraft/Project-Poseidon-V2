...
public class WorldGenMinable extends WorldGenerator {
    ...
    public boolean a(World world, Random random, int i, int j, int k) {
        ...
        double d0 = (float) (i + 8) + MathHelper.sin(f) * (float) this.b / 8.0F;
        double d1 = (float) (i + 8) - MathHelper.sin(f) * (float) this.b / 8.0F;
        double d2 = (float) (k + 8) + MathHelper.cos(f) * (float) this.b / 8.0F;
        double d3 = (float) (k + 8) - MathHelper.cos(f) * (float) this.b / 8.0F;
